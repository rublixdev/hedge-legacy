...
contract BetToken is StandardToken {
  using SafeMath for uint256;
  ...
  function BetToken(address _owner) public {
...
contract EscrowVault is Ownable
{
    ...
    */
    function EscrowVault(address _wallet, BetToken _token) public
    {
...
contract Betting is Ownable, usingOraclize
{
   ...
   // vault used to hold tokens while Betting is running
   ...
   //owner amount of token to bet
     ...
     * @param _endTime is in how many seconds will the betting expire from now
     */

    function Betting(address _tokenaddress, address _wallet, uint256 _price, uint256 _predictedValue, uint256 _endTime)public
    payable
     {
